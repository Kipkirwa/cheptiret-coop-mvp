    ...
    def send(self, phone_number: str, message: str, db: Session, farmer_id: Optional[int] = None) -> dict:
        ...
        try:
            ...
            cmd = [
                ...
                "-d", f"username={self.username}&to={formatted_phone}&message={encoded_message}&sender_id={self.sender_id}"
            ]
